...
var _config = __webpack_require__(662);
...
var action = function action(option) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return _this.webapi.person.query({ pagination: pagination, filter: filter });
    ...
    this.isSelectAll = function () {
        var lst = _this.metaAction.gf('data.list');
    ...
    this.getBirthdayRange = function () {
        var birthdayRange = _this.metaAction.gf('data.filter.birthdayRange');
        if (birthdayRange) {
            return birthdayRange.toJS();
        }
    };

    this.birthdayRangeChange = function (dates) {
        var pagination = _this.metaAction.gf('data.pagination').toJS(),
            filter = _this.metaAction.gf('data.filter').toJS();
    ...
    this.editRow = function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
            ...
            var _args$pop, rowIndex, row, ret;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            if (_this.config.apps['mk-app-person-card']) {
                                _context2.next = 4;
                                break;
                            }
                        ...
                        case 4:
                            ...
                            return _this.metaAction.modal('show', {
                                title: '人员',
                                children: _this.metaAction.loadApp('mk-app-person-card?from=list', {
...
var _data = __webpack_require__(678);
...
var reducer = function reducer(option) {
    ...
    this.selectAll = function (state, checked) {
        var lst = _this.metaReducer.gf(state, 'data.list');

        if (!lst || lst.size == 0) return state;

        for (var i = 0; i < lst.size; i++) {
            state = _this.metaReducer.sf(state, 'data.list.' + i + '.selected', checked);
        }
...
//# sourceMappingURL=mk-app-person-list.735af383.chunk.js.map